    ...
    <div className="testimonials-section ">
      <div className="container">
        <div className="section-intro">
          ...
          <h2 className="heading-test-secton">What our customers <br />are Saying about Brantfort!</h2>
          <p className="user-brification">Hear from our satisfied buyers, tenants, owners and dealers</p>
        </div>
        ...
        <div>
          <button className="btn view-all-testimonial">View all testimonial<BsArrowRight className="ms-2" /></button>
        </div>
