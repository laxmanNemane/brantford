            ...
            <div className="col-lg-8 col-md-8 col-sm-12">
              ...
              <div className="description-offices">
                ...
                <div className="decription-paragraph">
                  <p>
                    This co-working space is located in one of the prime
                    locations of Ahmedabad. It offers comprehensive business
                    solutions to all its clients.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    and exchange services from each other. This is a new, unique
                    and better way of working, growing, and expanding.
                  </p>
                </div>
              </div>
